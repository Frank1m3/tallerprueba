# archivo: app/dao/gestionar_compras/registrar_solicitud_compras/dto/solicitud_de_compra_detalle_dto.py
from typing import Optional

class SolicitudDetalleDto:
    """
    DTO para el detalle de una solicitud de compra.
    Representa cada ítem solicitado junto con cantidad.
    """
    ...
    def cantidad(self) -> float:
        """Alias para compatibilidad con SolicitudCompraDao."""
        return self.__cant_solicitada
